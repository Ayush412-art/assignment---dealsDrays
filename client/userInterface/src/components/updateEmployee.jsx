...
const getEmployeeData = async() =>{
        ...
        try{
            const emp_data = await axios.get(`http://localhost:8080/dashboard/getEmployee/${id}`);
            console.log(emp_data.data.name);
            setEmployeeData(emp_data.data)
            
            // nameRef.current.value = EmployeeData.name;
            // // mobRef.current.value = EmployeeData.mobile;
            // // genRef.current.value = EmployeeData.gender;
            // // designationRef.current.value = EmployeeData.designation;
            // // courseRef.current.value = EmployeeData.course
